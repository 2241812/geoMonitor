...
Object.assign(APP, {
  ...
  _toggleLCM() {
    ...
    const fetchBtn = document.getElementById('lcm-fetch-btn');
    if (fetchBtn) fetchBtn.style.display = this.state.showLCM ? 'block' : 'none';
  ...
  _updateHydroLabels() {
    ...
    // We lowered minZoom to 8, so make labels visible down to zoom 8
